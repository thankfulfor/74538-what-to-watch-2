...
/* App.propTypes ставлю после объявления App, потому что в обратном случае проект не отображает и в консоли ошибка:
    app.jsx:16 Uncaught ReferenceError: Cannot access 'App' before initialization
    at Module../src/components/app/app.jsx (app.jsx:16)
    https://yadi.sk/i/VuZmQmCJg34vaw
*/
App.propTypes = {
